/**
 * UploadZone — drag-and-drop CSV upload, theme-aware.
 */
        ...
        <div style={{
          ...
          {loading ? (
            <>
              ...
              <p style={{ color: "var(--text)", fontWeight: 600, fontSize: 14, margin: "0 0 4px" }}>
                Parsing your data...
              </p>
            ...
            <>
              <div style={{
                ...
                background: dragging ? "var(--accent)" : "var(--bg-alt)",
                display: "flex", alignItems: "center", justifyContent: "center",
                transition: "all 0.2s",
              }}>
                <svg width="22" height="22" fill="none" viewBox="0 0 24 24"
                  stroke={dragging ? "var(--bg)" : "var(--text-muted)"} strokeWidth={1.5}>
              ...
              <p style={{ color: "var(--text-muted)", fontSize: 13, margin: "0 0 8px" }}>
                Drag & drop or{" "}
                <span style={{ color: "var(--accent-text)", textDecoration: "underline" }}>browse files</span>
              </p>
              <p style={{ color: "var(--text-muted)", fontSize: 11, margin: 0, fontFamily: "var(--font-mono)", opacity: 0.6 }}>
                CSV only · no size limit
              </p>
            </>
          )}
        </div>
